...
import { CheckCircle2, Download, Loader, X, XCircle } from "lucide-react";
...
interface PersonTableFloatingBarProps {
  table: Table<AdminPerson>;
}

export function PersonTableFloatingBar({ table }: PersonTableFloatingBarProps) {
              ...
              {/* <Select
                onValueChange={(value: string) => {
                  ...
                  startTransition(async () => {
                    const result = await bulkUpdateStatusParties({
                    ...
                    if ("data" in result && result.data) {
                      ...
                      toast.success(
                        `${result.data.count} partido(s) ${status} correctamente`,
                      );
                    }
